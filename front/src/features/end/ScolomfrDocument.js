                        ...
                        return <Typography
                            ...
                            <Link underline="hover" target="_blank"
                                ...
                                sx={{
                                    ...
                                    visibility: (hoveredKey === entryKey) ? 'visible' : 'hidden'
                                }}/></Link></Typography>;
                    })
                } </Breadcrumbs>
            </ListItem>
    ...
    return (
        <Grid container direction="column" spacing={2} id={printMode ? "notice-print" : "notice-display"}
              sx={{
                  ...
                  position: printMode ? 'fixed' : 'static',
            ...
            {domainValues && <><Grid component={"div"} item width="100%" m={0} py={0} mt={2}
                                     sx={{
                                         padding: 0,
                                         color: theme.palette.secondary.light
                                     }}><Typography component="h4" py={0}
            ...
            {domainValues && <><Grid component={"div"} item width="100%" m={0} py={0} mt={2}
                                     sx={{
                                         ...
                                         color: theme.palette.secondary.light
                                                    ...
                                                    variant="h6">Niveau(x) éducatif(x)</Typography></Grid>
                <Grid component={"div"} item width="100%" m={0} py={0} mt={2}
                      sx={{
                          mt: 0,
                          padding: 0,
